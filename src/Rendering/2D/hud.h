	...
	namespace _2D{
		...
		public:
				...
				button_boxes(std::array<my_utils::box, NONE>())
			{
				...
				shader[0] = my_utils::shader::load("../seeds/media/shader/hud/vs.glsl", GL_VERTEX_SHADER, true, &error_msg);
				shader[1] = my_utils::shader::load("../seeds/media/shader/hud/fs.glsl", GL_FRAGMENT_SHADER, true, &error_msg);
